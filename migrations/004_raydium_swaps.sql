...
CREATE INDEX idx_raydium_sender ON raydium_swaps(sender);
CREATE INDEX idx_raydium_pool   ON raydium_swaps(amm_pool);
CREATE INDEX idx_raydium_mints  ON raydium_swaps(mint_source, mint_destination);
